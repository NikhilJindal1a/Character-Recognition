...
###################################################################################################
def main():
    imgTrainingNumbers = cv2.imread(r'G:\Nikhil Jindal\Desktop\Projects\character_recog\training_chars.png')  
    ...
    for npaContour in npaContours:  # for each contour
        if cv2.contourArea(npaContour) > MIN_CONTOUR_AREA:  # if contour is big enough to consider
            ...
            cv2.imshow("training_chars.png", imgTrainingNumbers)  # show training numbers image, this will now have red rectangles drawn on it
    ...
    np.savetxt(r'G:\Nikhil Jindal\Desktop\Projects\character_recog\classifications.txt', npaClassifications)  # write flattened images to file
    np.savetxt(r'G:\Nikhil Jindal\Desktop\Projects\character_recog\flattened_images.txt', npaFlattenedImages)  #
